...
Public Class EncriptarClass
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Function Des_Encriptar(ByVal pl_S_password As String)

        Dim vl_S_passDes_Encrip As String = ""

        ' procedimiento de desencripcion
        For index = 1 To Len(pl_S_password) Step 3
            vl_S_passDes_Encrip = vl_S_passDes_Encrip & Chr(Val(Mid(pl_S_password, index, 3)))
        Next

        Return vl_S_passDes_Encrip
    End Function
